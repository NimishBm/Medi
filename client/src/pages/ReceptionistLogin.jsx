...
export const ReceptionistLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="grid grid-cols-1 md:grid-cols-2 h-screen">
        {/* Left Panel - Branding */}
        <div className="hidden md:flex flex-col justify-center items-start p-12 bg-gradient-to-br from-emerald-800 via-emerald-700 to-teal-700 text-white">
          ...
          <p className="text-emerald-100 text-lg mb-12">for Receptionists</p>

          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <CheckCircle size={20} className="text-green-300 mt-1 flex-shrink-0" />
              <div>
                <p className="font-semibold text-base">Manage Appointments</p>
                <p className="text-emerald-100 text-sm">Check in patients and manage bookings for your doctor</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle size={20} className="text-green-300 mt-1 flex-shrink-0" />
              <div>
                <p className="font-semibold text-base">Monitor Queue</p>
                <p className="text-emerald-100 text-sm">Track real-time patient queue for your assigned doctor</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle size={20} className="text-green-300 mt-1 flex-shrink-0" />
              <div>
                <p className="font-semibold text-base">View Daily Overview</p>
                <p className="text-emerald-100 text-sm">See today's stats, revenue, and appointment status</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center items-center p-6 md:p-12 bg-gray-50">
          <div className="w-full max-w-sm">
            ...
            <p className="text-gray-600 mb-8">Manage your doctor's appointments and queue</p>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-400 text-white py-2.5 rounded-lg font-bold transition-colors mt-6"
              >
